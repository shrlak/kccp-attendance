...
function Badge({ tone, children }: { tone: string; children: ReactNode }) {
  return (
    <div
      className="fx-rise mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full border border-current/20"
...
function DrawnCheck({ color }: { color: string }) {
  return (
    <div className="fx-rise mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full" style={{ background: color }}>
