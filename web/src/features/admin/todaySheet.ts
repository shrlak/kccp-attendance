...
// flag (name in `newMemberNames`); regular members carry no tag. Shared between the
// exported 출석부 and the 오늘 tab's live list so both mark people identically.
export function checkinTag(e: LogEntry, newMemberNames: Set<string>): TodaySheetTag {
